        ...
        style={{width:'100%', height: '100%'}}>
          ...
          <View style={loginpageStyle.containersize}>
              <Card style={loginpageStyle.card}>
                  ...
                  <Card.Content>
                      <TextInput activeOutlineColor="blue" outlineColor="black" mode="outlined" onChangeText={setEmail} placeholderTextColor='red' autoCapitalize='none' autoCorrect={false} autoCompleteType='email' label="Email" keyboardType="email-address"></TextInput>
                      ...
                      <Card.Actions style={{justifyContent: "center"}}>
                        <Button onPress={handleSubmit} uppercase={false} color="black" mode="contained">Sign in</Button>
