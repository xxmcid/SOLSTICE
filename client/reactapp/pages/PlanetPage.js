                ...
                <Card style={planetPageStyle.card} >
                    ...
                    <ScrollView>
                        <Card.Content>
                            ...
                            {type == 'sun' && (<TextInput style={{marginBottom:5}} activeOutlineColor="blue" outlineColor="black" mode="outlined" onChangeText={setGravitationalPull} value={gravitationalPull.toString()} autoCapitalize='none' autoCorrect={false} label="Gravitional Pull"></TextInput>)}
                            {type != 'sun' && (<TextInput style={{marginBottom:5}} activeOutlineColor="blue" outlineColor="black" mode="outlined" onChangeText={setDistance} value={distance.toString()} autoCapitalize='none' autoCorrect={false} label="Distance"></TextInput>)}
