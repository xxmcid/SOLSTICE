            ...
            <ThemeProvider theme={getTheme()}>
                ...
                <Positioner color='text.primary' backgroundColor='background.paper' borderRadius={2}>
                    <Grid container id='forgotPassContainer' columns={4} rowSpacing={2} columnSpacing={2} padding='24px'>
                        ...
                        <Grid item xs={4}>
                            <Typography align='center'>We have sent an e-mail to verify your account. Please be sure to verify your account before logging in! You may need to check your spam/promotions folder.</Typography>
                        </Grid>
