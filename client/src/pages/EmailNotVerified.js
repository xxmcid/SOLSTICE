                ...
                <Positioner color='text.primary' backgroundColor='background.paper' borderRadius={2}>
                    <Grid container id='forgotPassContainer' columns={4} rowSpacing={2} columnSpacing={2} padding='24px'>
                        <Grid item xs={4} justifyContent={'center'}>
                            <Typography align='center' fontWeight={'bold'} variant="h4">Something went wrong...</Typography>
                        </Grid>

                        <Grid item xs={4}>
                            <Typography align='center'>Make sure your email verification link is not over 15 minutes old. Please wait while we redirect you to sign in, or click the button below...</Typography>
                        </Grid>
